...
const Dashboard = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text Text style={styles.primary}>Suku bunga Saat ini</Text>
      ...
      <View style={styles.DashboardAreaTop}>
        <TouchableOpacity style={[styles.naviButton, styles.elevation]}
      ...
      <View style={styles.DashboardAreaTop}>
        ...
        <Text style={{fontWeight : '500', marginTop : 5}}>Reset Password</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.naviButton, styles.elevation]}
